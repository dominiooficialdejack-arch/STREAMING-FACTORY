...
def admin_dashboard():
    ...
    def row(item):
        ...
        return '<tr><td>' + field(item, 'title') + '</td><td>' + field(item, 'category') + '</td><td>Q ' + field(item, 'price') + '</td><td>' + field(item, 'stock') + '</td><td>' + edit + remove + '</td></tr>'
